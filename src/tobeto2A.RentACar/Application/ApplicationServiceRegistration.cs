...
public static class ApplicationServiceRegistration
{
    ...
    )
    {
        ...
        services.AddScoped<Stopwatch>();//verdiğimiz süreyi takip eden yapı PerformanceBehavior yapısı için gerekli sadece

        services.AddMediatR(configuration =>
        {//Bu kısımda sıralama önemli loglamayı yap sonra Authorization
